...
Разрешены любые ресурспаки, которые не дают вам никаких преимуществ над другими игроками, мы же рекомендуем присмотреться к ресурспакам из этого списка:

<Details summary="FaithcraftRP">
    FaithcraftRP - Наш ресурспак, который мы рекомендуем
    вам! Для работы потребуется установка [CIT Resewn](https://www.curseforge.com/minecraft/mc-mods/cit-resewn "blank")
    {/* //todo: Сделать компонент ссылки */}
    Тут вы можете найти все необходимые предметы для переименования

    {/* //todo: Сделать картинки меншьше */}
    ...
    <ColorBlock color="blue">
        Мы не претендуем на полную оригинальность нашего ресурспака. Несмотря на то, что некоторая часть
        моделек была нарисована нашей командой, некоторые модельки были взяты из разных бесплатных общественных
        ресурсов. Ресурспак будет активно обновляться и его наполенние будет именяться в звисимости от ваших пожеланий
    </ColorBlock>
</Details>

<Details summary="Vanilla Tweaks">
    [Vanilla Tweaks](https://vanillatweaks.net "blank") - Идеальный и полностью настраиваемый ресурспак, если вы хотите
    сохранить ванильный внешний вид игры.
</Details>

<Details summary="KSEPSP">
    [KSEPSP](https://www.planetminecraft.com/texture-pack/ksepsp-v8-0 "blank") - Ресурспак, меняющий внешний вид обычных
    предметов при их переименовании. Для работы потребуется установка [CIT Resewn](https://www.curseforge.com/minecraft/mc-mods/cit-resewn "blank")
</Details>
